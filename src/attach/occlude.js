...
module.exports = function () {
  ...
  const ZONES = {
    ak74: {
      ...
      mag: [{ box: [-20, -200, -215, 20, 50, -80], group: 'magazine' }],
    ...
    akm: {
      ...
      mag: [{ box: [-20, -200, -225, 20, 42, -75], group: 'magazine' }],
  ...
  function apply(THREE, host, weaponKey, config, opts) {
    ...
    host.traverse((o) => {
      ...
      const own = zones.filter((z) => !z.group);
